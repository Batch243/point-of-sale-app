#Credit due to S2t2 from prior semester- used to figure out how to import from Ipython and importing the date
...
print("-------------------------------")
print("MY STERN STORE")
print("-------------------------------")
print("Web: www.mysternstore.com")
print("Phone: 1.111.111.1111")
#credit here due again to prior quarter assignement for current date
